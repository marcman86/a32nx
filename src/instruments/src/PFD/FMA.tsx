...
const AB3Cell = () => {
    const [engineMessage] = useSimVar('L:A32NX_Engine_Message', 'enum');
    const [machPresel] = useSimVar('L:A32NX_MachPreselVal', 'mach');
...
const B1Cell = () => {
    ...
    const [softAltMode] = useSimVar('L:A32NX_FMA_SOFT_ALT_MODE', 'Bool');
    ...
    return (
        <g>
            ...
            {vsFpaNotHeld && (activeVerticalMode === 14 || activeVerticalMode === 15)
